...
highlight wStatus    ctermfg=red  
highlight wScope     ctermfg=yellow 
highlight wContext   ctermfg=blue
highlight wContact   ctermfg=magenta
highlight wDate      ctermfg=cyan
