    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        vscode.workspace.onDidChangeTextDocument(event => {
            ...
            if (globals_1.Globals.isTesting) {
                ...
                _.filter(modeHandlerToEditorIdentity, modeHandler => modeHandler.vimState.identity.fileName === event.document.fileName).forEach(modeHandler => {
        ...
        registerCommand(context, 'extension.showCmdLine', () => {
            let modeHandler = modeHandlerToEditorIdentity[new editorIdentity_1.EditorIdentity(vscode.window.activeTextEditor).toString()];
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (isDisabled) {
                    vscode.window.visibleTextEditors.forEach(e => {
                        e.options.cursorStyle = configuration_1.Configuration.userCursor;
                    });
                    statusBar_1.StatusBar.SetText('-- VIM: DISABLED --', mh.currentMode.name, true);
                }
                else {
                    compositionState = new CompositionState();
...
function handleContentChangedFromDisk(document) {
    _.filter(modeHandlerToEditorIdentity, modeHandler => modeHandler.vimState.identity.fileName === document.fileName).forEach(modeHandler => {
