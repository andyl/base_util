...
class ModeHandler {
    constructor() {
        ...
        this.vimState = new vimState_1.VimState(vscode.window.activeTextEditor, configuration_1.Configuration.startInInsertMode);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!this.vimState.isCurrentlyPerformingRemapping &&
                    ...
                    !globals_1.Globals.isTesting) {
                    handled = yield this._remappers.sendKey(keys, this, this.vimState);
                }
                if (handled) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < vimState.allCursors.length; i++) {
                ...
                if (movement.canBeRepeatedWithSemicolon(vimState, result)) {
                    vimState_1.VimState.lastRepeatableMovement = movement;
                }
            }
            ...
            for (const command of otherTransformations) {
                switch (command.type) {
                    ...
                    case 'showCommandLine':
                        yield commandLine_1.CommandLine.PromptAndRun(vimState.commandInitialText, this.vimState);
    ...
    updateView(vimState, args = {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let cursorStyle = mode_1.Mode.translateCursor(this.currentMode.cursorType);
            if (this.currentMode.cursorType === mode_1.VSCodeVimCursorType.Native &&
                configuration_1.Configuration.userCursor !== undefined) {
                cursorStyle = configuration_1.Configuration.userCursor;
            }
            const optionalCursorStyle = configuration_1.Configuration.cursorStylePerMode[this.currentMode.friendlyName.toLowerCase()];
            if (optionalCursorStyle !== undefined) {
                const cursorStyleNum = configuration_1.Configuration.cursorStyleFromString(optionalCursorStyle);
            ...
            */
            ...
            this._renderStatusBar();
            yield vscode.commands.executeCommand('setContext', 'vim.overrideCopy', configuration_1.Configuration.overrideCopy);
            yield vscode.commands.executeCommand('setContext', 'vim.overrideCtrlC', configuration_1.Configuration.overrideCopy || configuration_1.Configuration.useCtrlKeys);
        });
    }
    _renderStatusBar() {
        ...
        if (configuration_1.Configuration.statusBarColorControl) {
            ...
            if (colorToSet !== undefined) {
                statusBar_1.StatusBar.SetColor(colorToSet);
            }
        }
        let text = [];
        ...
        statusBar_1.StatusBar.SetText(text.join(' '), this.currentMode.name, forceUpdate);
    }
