...
let CommandCtrlVInSearchMode = class CommandCtrlVInSearchMode extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            const searchState = vimState.globalState.searchState;
            const textFromClipboard = util_1.Clipboard.Paste();
...
let PutCommandVisual = class PutCommandVisual extends BaseCommand {
    ...
    exec(position, vimState, after = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (register.registerMode === register_1.RegisterMode.LineWise) {
                let deleteResult = yield new operator.DeleteOperator(this.multicursorIndex).run(vimState, start, end, false);
                ...
                deleteResult.currentMode = mode_1.ModeName.Visual;
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (fileInfo) {
                ...
                const fileCommand = new file_1.FileCommand({ name: filePath, lineNumber: lineNumber });
                fileCommand.execute();
            }
            return vimState;
        });
...
let MoveToLowerPane = class MoveToLowerPane extends BaseCommand {
    constructor() {
        super(...arguments);
        this.modes = [mode_1.ModeName.Normal, mode_1.ModeName.Visual, mode_1.ModeName.VisualLine];
        this.keys = [['<C-w>', 'j'], ['<C-w>', '<down>'], ['<C-w j>']];
    }
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            vimState.postponedCodeViewChanges.push({
...
let ActionDeleteChar = class ActionDeleteChar extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const state = yield new operator.DeleteOperator(this.multicursorIndex).run(vimState, position, position);
...
let ActionDeleteLastChar = class ActionDeleteLastChar extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield new operator.DeleteOperator(this.multicursorIndex).run(vimState, position.getLeft(), position.getLeft());
        });
    }
};
